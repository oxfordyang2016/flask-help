...
db = MySQLdb.connect(host="192.168.201.142", user="root", passwd="123456",db="user")
cursor = db.cursor()
...
def signUpUser1():
    ...
    #password = request.form['password'];
    #print user,password
    randomint=random.randint(12,400)#give a random int
    print "i love jquery"
...
#-----------------flask authentication and login logic and connect database-----------
